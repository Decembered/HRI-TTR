...
def schema() -> Json:
    ...
    return {
        ...
        "source_notes": {
            "Bone-Seed": (
                "SMPL body pose_aa[T,72] and smpl_joints[T,24,3]; "
                "not complete SMPL-X; first 22 joints are authoritative"
            ),
            "Inter-X": "P1/P2 are separate single-person pairs",
            "HumanML3D": "HumanML clip mapped to the new amass_g1_ember retarget",
        },
    }
